  ...
  return (
    <div className="flex justify-center items-center h-screen w-screen background-image text-white">
      <div className="bg min-w-[400px] max-w-[400px] flex flex-col gap-y-1">
        <h1 className="text-center mb-3 text-2xl uppercase">Login</h1>
        <form
        ...
        >
          <div className="flex flex-col">
            ...
            <input
              className="border-2 rounded-xl px-3 py-3 outline-none"
              type="text"
              ...
              {...register("username", {
                ...
                pattern: {
                  value: /^[a-z]+$/,
                  message: "Username should be a all lowercase",
                },
              })}
            />
            {errors.username && (
          ...
          <div className="flex flex-col ">
            <div className="relative">
              <input
                className=" border-2 rounded-xl px-3 py-3 outline-none w-full pr-14"
